...
export default function PointsCard() {
  ...
  return (
    <section className="w-full" aria-labelledby="points-section-title">
      <div className="bg-main flex flex-wrap justify-between gap-5 rounded-3xl p-4 sm:p-7 overflow-hidden relative">
        {/* Content */}
        <div className="flex flex-col flex-1 min-w-[300px] gap-6 sm:gap-12 lg:max-w-[400px] xl:max-w-[600px]">
          ...
          <header className="w-full">
            ...
            <div className="mt-3 sm:mt-5 flex flex-wrap items-center justify-between gap-3 sm:gap-2 w-full">
              ...
              <Button
                className="bg-gradient-to-r from-[#F6CB42] to-[#FF9C00] text-sm sm:text-lg px-4 sm:px-8 py-2 rounded-full whitespace-nowrap"
          ...
          <div className="flex flex-col gap-2 w-full">
            ...
            <Progress
              ...
              className="bg-gray-200 [&>div]:bg-[#FF9C00] h-2 sm:h-3 w-full"
            />
